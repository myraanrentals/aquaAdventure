...
@Component({
  selector: 'app-party-cruise',
  templateUrl: './party-cruise.component.html',
  styleUrls: ['./party-cruise.component.scss']
})
export class PartyCruiseComponent {
